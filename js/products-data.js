/**
 * ProductsData — single source of truth for the product catalog.
 * menu.js, product-details.js, and search all read from this file so the
 * catalog only needs to be maintained in one place.
 */
(function (window) {
    const productsData = [
        ...
        { id: 4, category: "best-sellers", img: "https://i.pinimg.com/1200x/90/5c/4b/905c4b31e793d1a986fead40fe35b7c9.jpg", title: "Matcha Dream", rating: "4.4 (195 orders)", star: true, price: "$5.20", desc: "Authentic Japanese ceremonial-grade matcha blended into rich cream.", isNew: true },
        ...
        { id: 10, category: "sundaes", img: "https://i.pinimg.com/1200x/ca/e6/2a/cae62a3ed327c78ce2a5addc866eec75.jpg", title: "Mango Tango Sundae", rating: "4.9 (420 orders)", star: true, price: "$6.20", desc: "Tropical mango chunks paired with sweet vanilla and fruit drizzle.", isNew: true },
        ...
        { id: 31, category: "cakes", img: "https://i.pinimg.com/1200x/49/d5/ae/49d5aef143396ebf8b157bcf8cf75bcb.jpg", title: "Tiramisu Gelato Cake", rating: "4.8 (190 orders)", star: false, price: "$30.00", desc: "Coffee-soaked ladyfinger layers paired with mascarpone gelato.", isNew: true },
        ...
        { id: 42, category: "scoops", img: "https://i.pinimg.com/1200x/2e/ae/6c/2eae6c7b2288a22bc0f7fd69f89681a5.jpg", title: "Pistachio Royale Scoop", rating: "4.7 (310 orders)", star: false, price: "$5.90", desc: "Rich nutty pistachio flavor made with authentic Mediterranean nuts.", isNew: true },
        { id: 43, category: "scoops", img: "https://i.pinimg.com/1200x/90/49/6b/90496b672eb13e46595192c3ee285988.jpg", title: "Pumpkin Spice Scoop", rating: "4.3 (90 orders)", star: false, price: "$5.00", desc: "Cozy seasonal autumn spices blended into sweet cream.", isNew: true },
    ...
    // A product counts as "Best Seller" when it's flagged with a filled star.
    // "New" is a small hand-picked set (isNew: true above) so the badge stays rare and meaningful.
    productsData.forEach(p => {
        p.isBestSeller = !!p.star;
    });
    ...
    // Returns other products from the same category as `product`, for "You may also like".
    ...
    // Full-text search across title, description, and category — used by the menu search box.
